        ...
        <div class="row">
          <div class="col-sm-3 g-mb-40 g-mb-0--lg">
            ...
            <button v-if="$route.params.id == sharedState.user_id" v-on:click="onDeleteUser($route.params.id)" class="btn btn-block u-btn-outline-red g-rounded-50 g-py-12 g-mb-10">
              <i class="icon-ban g-pos-rel g-top-1 g-mr-5"></i> 注销账户
            </button>
            <!-- End Actions -->
          ...
          <div class="col-sm-9">
            ...
            <ul class="nav nav-tabs g-mb-20">
              <li class="nav-item">
                <router-link v-bind:to="{ name: 'UserOverview' }" v-bind:active-class="'active'" class="nav-link" v-bind:class="isUserOverView">个人信息 <span class="u-label g-font-size-11 g-bg-primary g-rounded-20 g-px-10"><i class="icon-layers g-pos-rel g-top-1 g-mr-8"></i></span></router-link>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <router-link v-bind:to="{ name: 'UserFollowedsPostsList' }" v-bind:active-class="'active'" class="nav-link">关注者文章 <span class="u-label g-font-size-11 g-bg-blue g-rounded-20 g-px-10">{{ user.followed_posts_count }}</span></router-link>
              </li>
            </ul>
